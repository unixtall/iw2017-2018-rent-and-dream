...
public class HousingEditor extends VerticalLayout {
	...
	@Autowired
	public HousingEditor(HousingService service, CityService cityService) {
		...
		assessment.setVisible(SecurityUtils.hasRole(UserRoleType.ADMIN));
	...
	public void init()
	{
		addComponents(citySearchForm, name, address, assessment, description, bedrooms, beds, airConditioner, actions);
	}
